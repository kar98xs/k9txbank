      ...
      >
        ...
        <Box
          sx={{
            ...
            borderRadius: "50%",
            filter: "blur(50px)",
            background: "rgba(26,58,116,0.25)",
            bottom: 60,
            right: 80,
        ...
        <Container maxWidth="xs" sx={{ position: "relative" }}>
          <Paper
            ...
            sx={{
              ...
              borderRadius: 4,
              background:
                "linear-gradient(135deg, rgba(12,18,40,0.85) 0%, rgba(10,22,54,0.9) 100%)",
              border: "1px solid rgba(45,127,249,0.25)",
              boxShadow:
                "0 0 30px rgba(45,127,249,0.25), inset 0 0 24px rgba(45,127,249,0.12)",
          ...
          >
            ...
            >
              ...
              <Typography
                variant="h5"
                sx={{ color: "#eaf2ff", fontWeight: 900, letterSpacing: 0.5 }}
              >
                K9TX Bank
              </Typography>
            </Box>
            <Typography
              variant="h4"
              sx={{ color: "#eaf2ff", fontWeight: 800, textAlign: "center" }}
            >
              Welcome Back
            </Typography>
            ...
            <Box component="form" onSubmit={formik.handleSubmit} sx={{ mt: 1 }}>
              ...
              <Button
                ...
                sx={{
                  ...
                  letterSpacing: 0.5,
                  background:
                    "linear-gradient(90deg, #2d7ff9 0%, #6aa0ff 100%)",
