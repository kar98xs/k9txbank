  ...
  return (
    ...
    >
      ...
      <Typography sx={{ color: "#9fb4ff", mb: 3 }}>
        Apply for a loan and track status
        {isAdmin ? "; review all applications" : ""}
      </Typography>
      ...
      {!isAdmin && (
        <Box
          component="form"
          onSubmit={submit}
          sx={{ display: "grid", gap: 2, maxWidth: 600, mb: 3 }}
        >
          <TextField
            label="Amount"
            type="number"
            ...
            <Box key={l.id}>
              <Box sx={{ py: 1.5 }}>
                <Typography sx={{ color: "#eaf2ff", fontWeight: 600 }}>
                  ₹{l.amount} for {l.term_months} months @ {l.interest_rate}%{" "}
                  {isAdmin && `(by ${l.applicant_username || l.applicant})`}
                </Typography>
                <Box
                  sx={{
                    display: "flex",
                ...
                {l.purpose && (
                  <Typography sx={{ color: "#9fb4ff", mt: 0.5 }}>
                    Purpose: {l.purpose}
                  </Typography>
                )}
              </Box>
